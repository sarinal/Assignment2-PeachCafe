...
namespace Assignment2_PeachCafe.Controllers
{
    public class FoodItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FoodItemId,MenuCourseId,Name,Description,Price,ImageUrl")] FoodItem foodItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FoodItemId,MenuCourseId,Name,Description,Price,ImageUrl")] FoodItem foodItem)
        {
            if (ModelState.IsValid)
            {
